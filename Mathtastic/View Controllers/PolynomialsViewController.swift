//
//  PolynomialsViewController.swift
//  MathApp
//
...
class PolynomialsViewController: UIViewController{
    ...
    @IBAction func button(_ sender: Any) {
        if((sender as AnyObject).tag == Int(rightAnswerPlacement)){
                   ...
                   result = "Correct"
                   points += 1
                   self.performSegue(withIdentifier: "popup8", sender: nil)
